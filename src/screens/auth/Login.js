...
export default function Login({ navigation }) {
    ...
    // const [username, setUsername] = useState('9595954447')
    ...
    return (
        <SafeAreaView style={styles.container} >
            ...
            <View style={{ justifyContent: 'flex-start', alignItems: 'flex-start', width, padding: 25, paddingTop: width * 0.1 }} >
                <Text style={{ fontSize: 30, color: '#2C3687', fontFamily: typography.montserrat_700, padding: 2 }} >Login</Text>
                <Text style={{ fontSize: 16, color: '#6A7180', padding: 2, fontFamily: typography.montserrat_400 }}>Login to continue</Text>
            </View>
