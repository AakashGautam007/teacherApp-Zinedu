...
const Filter = (props) => {
  ...
  return (
    <SafeAreaView style={STYLES.safeAreaContainer}>
      ...
      <HeaderComponent text="Filters" onPress={navigation.goBack} />
      <ScrollView
        ref={scrollRef}
      ...
      >
        <View style={styles.unverifiedCard}>
          <Text style={styles.unverifiedCardText}>
            Total unverified questions
          </Text>
          <Badge count={unverifiedCount} viewStyle={styles.badge} />
        </View>
        ...
        <View style={styles.infoContainer}>
          ...
          <View style={{ flex: 1 }}>
            <Text style={styles.unverifiedCardText}>
              To verify questions, select the subject and chapter
            </Text>
          </View>
        </View>
