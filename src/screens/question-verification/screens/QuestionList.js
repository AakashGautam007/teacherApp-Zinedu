            ...
            >
              ...
              <View style={styles.subHeadingContainer}>
                ...
                <DropDownPicker
                  ...
                  setValue={(value) => {
                    value != modalSelectedChapterId &&
                      setModalSelectedChapterId(value);
                  }}
              ...
              {questionObject?.chapter_assoc_id != modalSelectedChapterId && (
              ...
              {!compareTwoArrays(
                questionObject?.tag_ids,
                modalSelectedTags.map((item) => item?.id)
              ...
              {questionObject?.difficulty_level != modalSelectedDifficulty && (
              ...
              {FEATURE_TYPE.get(questionObject?.feature_type) !=
                modalSelectedFeature && (
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                if (validateEditQuestion()) {
                  ...
                  setChapterName(
                    modalChapterList.find(
                      (item) => item?.value == modalSelectedChapterId
                    )?.label
                  );
          ...
          <View style={styles.editModalContainer}>
            ...
            <View style={styles.searchBarContainer}>
              ...
              <TextInput
                value={searchKey}
                onChangeText={(value) => {
                  let temp = fullModalTagList.filter((item) =>
      ...
      >
        <View style={styles.editModalParentContainer}>
          <View style={styles.rejectModalContainer}>
            ...
            >
              What do you want to change in the question?
            </Text>
            <View style={styles.rejectReasonContainer}>
              <View style={{ flexDirection: "row", alignItems: "center" }}>
                ...
                <AttachmentButton
                  ...
                  // }}
                  allowedFileTypes={[DocumentPicker.types.images]}
                  customComponent={
