...
import { Button, StyleSheet, Text, View, Alert, TouchableOpacity, ActivityIndicator } from 'react-native'
...
const AddPpt = ({navigation,route}) => {
  ...
  console.log(D)
    ...
    return (
        <View style={{justifyContent:'flex-start',alignItems:'center',flex:1,backgroundColor:'white'}} >
            {/* <Text>sdd</Text> */}
            ...
            {doc!=null&&doc.type!='cancel'?<Ionicons name="checkmark" size={24} color="black" /> :null}
            </View>
            {/* <Button title='send ppt' onPress={()=>doc!==null?sendPpt():Alert.alert('Add .ppt File')}/> */}

            <View style={{width:'100%',justifyContent:'center',alignItems: 'center',}}>
            <TouchableOpacity 
                onPress={()=>doc!==null?sendPpt():Alert.alert('Add .ppt File')}
