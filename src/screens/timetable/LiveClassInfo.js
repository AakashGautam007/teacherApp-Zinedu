...
const LiveClassInfo = ({ navigation, route }) => {
  ...
  const getSchedule = async () => {
    ...
    console.log("clas data", D.studio_name);
  ...
  useEffect(() => {
    console.log(item.live_class_id);
  ...
  return (
    <SafeAreaView style={styles.container}>
      {liveClass.length != 0 && (
        ...
        >
          <Text style={styles.txt}>Live class Id : {item.live_class_id}</Text>
        ...
        >
          ...
          >
            {liveClass.length != 0 && (
              <TouchableOpacity
                onPress={() =>
                  navigation.navigate("NotesFile", { item: liveClass })
                }
                style={{
                  width: "45%",
                  justifyContent: "center",
              ...
              >
                {liveClass.note_info.length != 0 ? (
                  <Text style={styles.txt}>UPDATE NOTES</Text>
                ) : (
          ...
          >
            <TouchableOpacity
              onPress={() =>
                navigation.navigate("Chapter", { item: liveClass })
              }
              style={{
                width: "45%",
                justifyContent: "center",
            ...
            >
              <View>
                <Text style={styles.txt}>EDIT CHAPTER</Text>
              </View>
            </TouchableOpacity>

            <TouchableOpacity
              onPress={() =>
                navigation.navigate("SubjectEdit", { item: liveClass })
              }
              style={{
                width: "45%",
                justifyContent: "center",
            ...
            >
              <View>
                <Text style={styles.txt}>EDIT SUBJECT</Text>
              </View>
            </TouchableOpacity>
          </View>
          ...
          >
            {item.mode_of_class !== "Offline" && (
              <TouchableOpacity
                onPress={() =>
                  navigation.navigate("AddPpt", {
                    studio: data.data.studio_name,
                    idd: item.live_class_id,
                  })
                }
                style={{
                  width: "45%",
              ...
              >
                <View>
                  <Text style={styles.txt}>ADD PPT</Text>
                </View>
              </TouchableOpacity>
            )}
            <TouchableOpacity
              onPress={() =>
                navigation.navigate("ScanScreen", { item: item.live_class_id })
              }
              style={{
                width: "45%",
                justifyContent: "center",
