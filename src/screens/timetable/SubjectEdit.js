...
const SubjectEdit = ({ navigation, route }) => {
  ...
  const getChapters = async (subbb) => {
    ...
    const response = await fetch(
      `${ENDPOINT}/support/get-chapters/?subject=${subbb}`,
      requestOptions
    );
  ...
  const getMainSubject = async () => {
    ...
    const response = await fetch(
      `${ENDPOINT}/student/get-subject-list-by-liveclass/?id=${item.id}`,
      requestOptions
    );
    const D = await response.json();
  ...
  const getAllMainSubject = async () => {
    ...
    const response = await fetch(
      `${ENDPOINT}/support/get-subjects/?is_main_subject=True`,
      requestOptions
    );
    const D = await response.json();
