...
const Doubt = ({ navigation, route }) => {
          ...
          [
            {
              text: "Enter Dte info",
              onPress: () =>
                navigation.navigate("DppInfo", { question, image }),
              style: "default",
            },
          ],
          {
  ...
  return (
    <View style={styles.container}>
      ...
      {image != null ? (
        <Button title="submit solution image" onPress={() => updateD(image)} />
      ) : null}
      <View style={styles.container}>
        {image != null ? (
          <ImageBackground
        ...
        >
          <Camera style={styles.camera} ref={cam} autoFocus="on" type={type}>
